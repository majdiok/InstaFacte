"""Restore CustomSystemFeatures.cs with nav schema-missing hardening (UTF-8 safe)."""
from pathlib import Path

content = r'''using System.Text.Json;
...
path = Path(__file__).resolve().parents[1] / "src/Backend/FactuTrust.Application/Features/Studio/Systems/CustomSystemFeatures.cs"
