import pathlib
p = pathlib.Path(r"c:\Solution\FactuTrust - Copy\src\Backend\FactuTrust.Infrastructure\Services\DocumentNumberMapper.cs")
p.write_text("""using FactuTrust.Domain.Common;
