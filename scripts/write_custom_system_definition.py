...
content = """namespace FactuTrust.Domain.Entities.Studio;
...
path = Path(__file__).resolve().parents[1] / "src/Backend/FactuTrust.Domain/Entities/Studio/CustomSystemDefinition.cs"
