...
export const SECTOR_RULES_FR = {
  ...
  'banner.source.db': 'Base de données (UseDbRules activé)',
  'banner.source.code': 'Catalogue statique (code) — UseDbRules désactivé',
  'banner.version': 'version {version}',
  'banner.updated': 'modifiée le {date} par {who}',
  'banner.updated.unknown': 'inconnu',
  ...
  'segments.form.subtitle': 'Sous-titre',
  'segments.form.icon': 'Icône (classe PrimeIcons)',
  'segments.form.tone': 'Teinte',
  ...
  'domains.form.icon': 'Icône (classe PrimeIcons)',
  'domains.form.tone': 'Teinte',
