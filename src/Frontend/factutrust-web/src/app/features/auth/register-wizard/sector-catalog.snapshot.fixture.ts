...
export const SECTOR_CATALOG_SNAPSHOT_FIXTURE: SectorCatalogDto & { catalogVersion: string } = {
  ...
  modules: [
    ...
    { id: 11, code: 'AI', labelFr: 'Assistant IA', isCore: false, availableOnFreePlan: true },
    { id: 12, code: 'Forecasting', labelFr: 'Prévisions IA', isCore: false, availableOnFreePlan: true },
    { id: 13, code: 'Studio', labelFr: 'Studio (low-code)', isCore: false, availableOnFreePlan: true },
    { id: 14, code: 'Payroll', labelFr: 'RH & Paie', isCore: false, availableOnFreePlan: true },
