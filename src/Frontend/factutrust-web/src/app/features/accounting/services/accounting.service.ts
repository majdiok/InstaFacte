...
export interface JournalEntryDto {
  ...
  isReversed: boolean;
  /** Écriture d'origine si cette pièce est une extourne (null sinon). */
...
export class AccountingService {
  ...
  /** Charge une écriture (lignes incluses) pour l'écran d'édition d'un brouillon. */
  getJournalEntry(id: string): Observable<ApiResponse<JournalEntryDto>> {
    return this.http.get<ApiResponse<JournalEntryDto>>(`${this.base}/journal/${id}`);
  }
