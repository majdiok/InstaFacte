...
{
    /// <inheritdoc />
    public partial class AddPlansAndModuleOverrides_Master : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePriceTND = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanLimits_PlanId_Key",
                table: "PlanLimits",
                columns: new[] { "PlanId", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PlanModules_PlanId_Module",
                table: "PlanModules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantModuleOverrides_ExpiresAt",
                table: "TenantModuleOverrides",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_TenantModuleOverrides_TenantId_Module",
                table: "TenantModuleOverrides",
