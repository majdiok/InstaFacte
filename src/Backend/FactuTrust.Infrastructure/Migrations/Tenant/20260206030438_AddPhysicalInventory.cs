        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryCountLines_PhysicalInventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryCountLines_InventoryId_ProductId",
                table: "InventoryCountLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhysicalInventories_StartedAt",
                table: "PhysicalInventories",
                column: "StartedAt");

            migrationBuilder.CreateIndex(
                name: "IX_PhysicalInventories_Status",
                table: "PhysicalInventories",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhysicalInventories_WarehouseId_Status",
                table: "PhysicalInventories",
