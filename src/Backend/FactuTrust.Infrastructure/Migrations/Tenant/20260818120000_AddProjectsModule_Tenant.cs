...
/// <summary>
/// Module Projets / PSA : agrégats projet, temps, budget, jalons, situations BTP,
/// plus colonnes additives nullable sur Invoices et PurchaseOrders.
/// Migration manuelle (scaffold EF bloqué par snapshot existant).
/// </summary>
[DbContext(typeof(TenantDbContext))]
[Migration("20260818120000_AddProjectsModule_Tenant")]
public partial class AddProjectsModule_Tenant : Migration
{
...
""");
    ...
    {
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectBillings];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectSubcontractors];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectSituations];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectMilestones];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectActivities];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectCostLines];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectTimeEntries];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectMembers];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectAttachments];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectComments];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectTaskDependencies];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectTasks];");
        migrationBuilder.Sql("DROP TABLE IF EXISTS [ProjectPhases];");
